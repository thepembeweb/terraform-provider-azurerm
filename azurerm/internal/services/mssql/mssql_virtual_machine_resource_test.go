	...
	data.ResourceTest(t, r, []resource.TestStep{
		{
			...
			Check: resource.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
				check.That(data.ResourceName).Key("r_services_enabled").HasValue("true"),
				check.That(data.ResourceName).Key("sql_connectivity_type").HasValue("PRIVATE"),
				check.That(data.ResourceName).Key("sql_connectivity_port").HasValue("1433"),
			),
		},
		data.ImportStep("sql_connectivity_update_password", "sql_connectivity_update_username"),
		{
			...
			Check: resource.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
				check.That(data.ResourceName).Key("r_services_enabled").HasValue("false"),
				check.That(data.ResourceName).Key("sql_connectivity_type").HasValue("PUBLIC"),
				check.That(data.ResourceName).Key("sql_connectivity_port").HasValue("1533"),
			),
		},
		data.ImportStep("sql_connectivity_update_password", "sql_connectivity_update_username"),
	})
	...
	data.ResourceTest(t, r, []resource.TestStep{
		{
			...
			Check: resource.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
				check.That(data.ResourceName).Key("auto_patching.0.day_of_week").HasValue("Sunday"),
				check.That(data.ResourceName).Key("auto_patching.0.maintenance_window_duration_in_minutes").HasValue("60"),
				check.That(data.ResourceName).Key("auto_patching.0.maintenance_window_starting_hour").HasValue("2"),
			),
		},
		data.ImportStep(),
		{
			...
			Check: resource.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
				check.That(data.ResourceName).Key("auto_patching.0.day_of_week").HasValue("Monday"),
				check.That(data.ResourceName).Key("auto_patching.0.maintenance_window_duration_in_minutes").HasValue("90"),
				check.That(data.ResourceName).Key("auto_patching.0.maintenance_window_starting_hour").HasValue("4"),
			),
		},
		data.ImportStep(),
	})
